...
if __name__ == "__main__":
    ...
    with TemporaryDirectory() as tmp_dir:
        ...
        subprocess.check_call(
            [  # noqa: S607  Trusted command  # disabled globally: noqa: S603
                "pip-licenses",
                "--with-authors",
                "--with-system",
                "--with-urls",
        ...
        (DOCS_PATH / "license_compliance.rst").write_text(JINJA_ENVIRONMENT.get_template("license_compliance.rst.j2").render(licenses=licenses), encoding="utf-8")
        # out_file = DOCS_PATH / "license_compliance.rst"
        # file_template = JINJA_ENVIRONMENT.get_template("license_compliance.rst.j2")
        # file_text = file_template.render(licenses=licenses)
